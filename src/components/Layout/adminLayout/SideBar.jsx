...
const navItems = [
    ...
    { to: '/admin/configuracion', label: 'Configuración', icon: <FaCog />, adminOnly: true }
];
        ...
        <>
            ...
            <aside
                className={`fixed lg:static inset-y-0 left-0 overflow-hidden z-100 w-68
                    shrink-0 bg-linear-to-b from-green-500 to-green-900 min-h-screen overflow-y-auto flex flex-col transition-all duration-300
            ...
            >
                ...
                <div className="flex items-center gap-3 p-4 border-b border-white/10 min-h-17.5">
                    ...
                    <div>
                        <div className="text-white font-bold text-sm">{user?.rol}</div>
                ...
                <div className="p-4 border-t border-white/10 bg-black/20 space-y-2">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-2 py-2 text-xs font-medium text-white bg-red-800/50 rounded-lg hover:bg-red-700 transition-colors"
                    >
                        <FaDoorOpen />
                        Cerrar Sesión
                    </button>
